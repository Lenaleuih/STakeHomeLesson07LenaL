...
public class PresidentViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setPresidentNameView(TextView presidentNameView) {
        this.presidentNameView = presidentNameView;
    }
    ...
    public void setPresidentInfoView(TextView presidentInfoView) {
        this.presidentInfoView = presidentInfoView;
    }
    ...
    public void setPresidentPhotoView(ImageView presidentPhotoView) {
        this.presidentPhotoView = presidentPhotoView;
    }
